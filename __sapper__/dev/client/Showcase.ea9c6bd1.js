...
import { A as ArtistListing } from './ArtistListing.b92c8a44.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-2xp7ff");
			add_location(div0, file, 73, 8, 1687);
			attr_dev(img, "class", "item-cover svelte-2xp7ff");
			...
			attr_dev(a0, "class", "item-cover-container svelte-2xp7ff");
			...
			attr_dev(a1, "class", "name text-no-overflow svelte-2xp7ff");
			...
			attr_dev(div1, "class", "item svelte-2xp7ff");
