...
import { A as ArtistListing } from './ArtistListing.ffe4f527.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 96, 0, 2656);
			attr_dev(footer, "id", "sentinel");
			attr_dev(footer, "class", "svelte-rhnqca");
			add_location(footer, file$1, 113, 4, 3192);
			...
			add_location(div, file$1, 97, 0, 2673);
		},
		m: function mount(target, anchor) {
