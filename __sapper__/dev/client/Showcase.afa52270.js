...
import { A as ArtistListing } from './ArtistListing.1d2e2e95.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-1348ofm");
			add_location(div0, file, 73, 8, 1689);
			attr_dev(img, "class", "item-cover svelte-1348ofm");
			...
			add_location(img, file, 74, 8, 1729);
			attr_dev(a0, "class", "item-cover-container svelte-1348ofm");

			attr_dev(a0, "href", a0_href_value = "/albums/" + (/*type*/ ctx[2] == "tracks"
			? /*info*/ ctx[0].album.id
			: /*info*/ ctx[0].id));

			add_location(a0, file, 70, 4, 1572);
			attr_dev(a1, "class", "name text-no-overflow svelte-1348ofm");

			attr_dev(a1, "href", a1_href_value = "/albums/" + (/*type*/ ctx[2] == "tracks"
			? /*info*/ ctx[0].album.id
			: /*info*/ ctx[0].id));

			add_location(a1, file, 79, 4, 1890);
			attr_dev(div1, "class", "item svelte-1348ofm");
			attr_dev(div1, "id", /*key*/ ctx[3]);
			set_style(div1, "--width", /*width*/ ctx[4] + "px");
			set_style(div1, "--margin", /*marginLeft*/ ctx[1] + "px");
			add_location(div1, file, 65, 0, 1452);
		},
