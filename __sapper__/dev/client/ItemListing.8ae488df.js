...
import { A as ArtistListing } from './ArtistListing.90f722de.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(b, file, 83, 8, 1701);
			attr_dev(p, "class", "time");
			add_location(p, file, 84, 8, 1766);
			attr_dev(div1, "class", "right svelte-5w0whk");
			add_location(div1, file, 82, 4, 1673);
