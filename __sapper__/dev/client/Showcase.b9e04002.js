...
import { A as ArtistListing } from './ArtistListing.5b1deb21.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-b9pwd3");
			add_location(div0, file, 73, 8, 1687);
			attr_dev(img, "class", "item-cover svelte-b9pwd3");
			...
			attr_dev(a0, "class", "item-cover-container svelte-b9pwd3");
			...
			attr_dev(a1, "class", "name text-no-overflow svelte-b9pwd3");
			...
			attr_dev(div1, "class", "item svelte-b9pwd3");
