...
import { A as ArtistListing } from './ArtistListing.c5191980.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-1fmzy6h");
			add_location(div0, file, 80, 8, 1957);
			attr_dev(img, "class", "item-cover svelte-1fmzy6h");
			...
			add_location(img, file, 81, 8, 1997);
			attr_dev(a0, "class", "item-cover-container svelte-1fmzy6h");

			attr_dev(a0, "href", a0_href_value = "/albums/" + (/*type*/ ctx[2] == "tracks"
			? /*info*/ ctx[0].album.id
			: /*info*/ ctx[0].id));

			add_location(a0, file, 77, 4, 1840);
			attr_dev(a1, "class", "name text-no-overflow svelte-1fmzy6h");

			attr_dev(a1, "href", a1_href_value = "/albums/" + (/*type*/ ctx[2] == "tracks"
			? /*info*/ ctx[0].album.id
			: /*info*/ ctx[0].id));

			add_location(a1, file, 86, 4, 2158);
			attr_dev(div1, "class", "item svelte-1fmzy6h");
			attr_dev(div1, "id", /*key*/ ctx[3]);
			set_style(div1, "--width", /*width*/ ctx[4] + "px");
			set_style(div1, "--margin", /*marginLeft*/ ctx[1] + "px");
			add_location(div1, file, 72, 0, 1720);
		},
