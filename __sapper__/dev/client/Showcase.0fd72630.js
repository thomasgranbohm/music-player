...
import { A as ArtistListing } from './ArtistListing.5682363b.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-xbmfck");
			add_location(div0, file, 77, 8, 1816);
			attr_dev(img, "class", "item-cover svelte-xbmfck");
			...
			attr_dev(a0, "class", "item-cover-container svelte-xbmfck");
			...
			attr_dev(a1, "class", "name text-no-overflow svelte-xbmfck");
			...
			attr_dev(div1, "class", "item svelte-xbmfck");
