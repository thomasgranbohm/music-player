...
import { A as ArtistListing } from './ArtistListing.6b19ba31.js';
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(img, "class", "track-cover svelte-1j2qexv");
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a, "class", "svelte-1j2qexv");
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "left svelte-1j2qexv");
			...
			attr_dev(div1, "class", "right svelte-1j2qexv");
			add_location(div1, file, 81, 4, 1663);
			attr_dev(div2, "class", "track svelte-1j2qexv");
