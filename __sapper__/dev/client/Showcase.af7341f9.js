...
import { A as ArtistListing } from './ArtistListing.b55364a7.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-3zwne");
			add_location(div0, file, 70, 8, 1652);
			attr_dev(img, "class", "item-cover svelte-3zwne");
			...
			attr_dev(a0, "class", "item-cover-container svelte-3zwne");
			...
			attr_dev(a1, "class", "name text-no-overflow svelte-3zwne");
			...
			attr_dev(div1, "class", "item svelte-3zwne");
