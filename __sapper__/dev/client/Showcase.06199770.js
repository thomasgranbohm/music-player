...
import { A as ArtistListing } from './ArtistListing.e9a13283.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-14nmkon");
			add_location(div0, file, 73, 8, 1687);
			attr_dev(img, "class", "item-cover svelte-14nmkon");
			...
			attr_dev(a0, "class", "item-cover-container svelte-14nmkon");
			...
			attr_dev(a1, "class", "name text-no-overflow svelte-14nmkon");
			...
			attr_dev(div1, "class", "item svelte-14nmkon");
