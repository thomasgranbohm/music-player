...
import { A as ArtistListing } from './ArtistListing.e2638a5e.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-hss3wg");
			add_location(div0, file, 71, 8, 1653);
			attr_dev(img, "class", "item-cover svelte-hss3wg");
			...
			attr_dev(a0, "class", "item-cover-container svelte-hss3wg");
			...
			attr_dev(a1, "class", "name text-no-overflow svelte-hss3wg");
			...
			attr_dev(div1, "class", "item svelte-hss3wg");
