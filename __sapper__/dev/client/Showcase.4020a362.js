...
import { A as ArtistListing } from './ArtistListing.8ee5f27b.js';
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file$1, 117, 12, 3298);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1v82uvc");
			add_location(h1, file$1, 98, 0, 2674);
			attr_dev(footer, "id", "sentinel");
			attr_dev(footer, "class", "svelte-1v82uvc");
			add_location(footer, file$1, 115, 4, 3210);
			attr_dev(div, "class", "items svelte-1v82uvc");
