...
import { A as ArtistListing } from './ArtistListing.b3cfa74f.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-1y5a0rg");
			add_location(div0, file, 73, 8, 1771);
			attr_dev(img, "class", "item-cover svelte-1y5a0rg");
			...
			add_location(img, file, 74, 8, 1811);
			attr_dev(a0, "class", "item-cover-container svelte-1y5a0rg");

			attr_dev(a0, "href", a0_href_value = "/albums/" + (/*type*/ ctx[2] == "tracks"
			? /*info*/ ctx[0].album.id
			: /*info*/ ctx[0].id));

			add_location(a0, file, 70, 4, 1654);
			attr_dev(a1, "class", "name text-no-overflow svelte-1y5a0rg");

			attr_dev(a1, "href", a1_href_value = "/albums/" + (/*type*/ ctx[2] == "tracks"
			? /*info*/ ctx[0].album.id
			: /*info*/ ctx[0].id));

			add_location(a1, file, 79, 4, 1972);
			attr_dev(div1, "class", "item svelte-1y5a0rg");
			attr_dev(div1, "id", /*key*/ ctx[3]);
			set_style(div1, "--width", /*width*/ ctx[4] + "px");
			set_style(div1, "--margin", /*marginLeft*/ ctx[1] + "px");
			add_location(div1, file, 65, 0, 1534);
		},
