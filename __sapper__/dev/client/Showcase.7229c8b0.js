...
import { A as ArtistListing } from './ArtistListing.b266b114.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 74, 8, 1772);
			...
			add_location(a1, file, 79, 4, 1933);
