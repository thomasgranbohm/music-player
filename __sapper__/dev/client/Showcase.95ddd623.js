...
import { A as ArtistListing } from './ArtistListing.29badfc6.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-10xq2d3");
			add_location(div0, file, 75, 8, 1776);
			attr_dev(img, "class", "item-cover svelte-10xq2d3");
			...
			add_location(img, file, 76, 8, 1816);
			attr_dev(a0, "class", "item-cover-container svelte-10xq2d3");

			attr_dev(a0, "href", a0_href_value = "/albums/" + (/*type*/ ctx[2] == "tracks"
			? /*info*/ ctx[0].album.id
			: /*info*/ ctx[0].id));

			add_location(a0, file, 72, 4, 1659);
			attr_dev(a1, "class", "name text-no-overflow svelte-10xq2d3");

			attr_dev(a1, "href", a1_href_value = "/albums/" + (/*type*/ ctx[2] == "tracks"
			? /*info*/ ctx[0].album.id
			: /*info*/ ctx[0].id));

			add_location(a1, file, 81, 4, 1977);
			attr_dev(div1, "class", "item svelte-10xq2d3");
			attr_dev(div1, "id", /*key*/ ctx[3]);
			set_style(div1, "--width", /*width*/ ctx[4] + "px");
			set_style(div1, "--margin", /*marginLeft*/ ctx[1] + "px");
			add_location(div1, file, 67, 0, 1539);
		},
