...
import { A as ArtistListing } from './ArtistListing.d2fee2dc.js';
...
function create_fragment(ctx) {
	...
	let t5;
	let t6;
	let t7_value = new String(Math.floor(/*item*/ ctx[0].duration_ms % 60000 / 1000).padStart()) + "";
	let t7;
	let div2_id_value;
	let current;
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			...
			if ((!current || dirty & /*item*/ 1) && t7_value !== (t7_value = new String(Math.floor(/*item*/ ctx[0].duration_ms % 60000 / 1000).padStart()) + "")) set_data_dev(t7, t7_value);
