...
import { A as ArtistListing } from './ArtistListing.23f0efb8.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 98, 0, 2691);
			attr_dev(footer, "id", "sentinel");
			attr_dev(footer, "class", "svelte-rhnqca");
			add_location(footer, file$1, 115, 4, 3227);
			...
			add_location(div, file$1, 99, 0, 2708);
		},
		m: function mount(target, anchor) {
