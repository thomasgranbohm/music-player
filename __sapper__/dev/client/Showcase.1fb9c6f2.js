...
import { A as ArtistListing } from './ArtistListing.923c005f.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 95, 0, 2615);
			attr_dev(footer, "id", "sentinel");
			attr_dev(footer, "class", "svelte-rhnqca");
			add_location(footer, file$1, 112, 4, 3151);
			...
			add_location(div, file$1, 96, 0, 2632);
		},
		m: function mount(target, anchor) {
