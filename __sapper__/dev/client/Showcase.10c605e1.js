...
import { A as ArtistListing } from './ArtistListing.897497f4.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-1c67pgj");
			add_location(div0, file, 73, 8, 1687);
			attr_dev(img, "class", "item-cover svelte-1c67pgj");
			...
			attr_dev(a0, "class", "item-cover-container svelte-1c67pgj");
			...
			attr_dev(a1, "class", "name text-no-overflow svelte-1c67pgj");
			...
			attr_dev(div1, "class", "item svelte-1c67pgj");
