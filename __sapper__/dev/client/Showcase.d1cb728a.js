...
import { A as ArtistListing } from './ArtistListing.335964cc.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1glsm14");
			add_location(h1, file$1, 98, 0, 2673);
			attr_dev(footer, "id", "sentinel");
			attr_dev(footer, "class", "svelte-1glsm14");
			add_location(footer, file$1, 115, 4, 3209);
			attr_dev(div, "class", "items svelte-1glsm14");
