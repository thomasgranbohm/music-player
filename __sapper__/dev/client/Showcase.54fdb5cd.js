...
import { A as ArtistListing } from './ArtistListing.6b7b33e7.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 98, 0, 2692);
			attr_dev(footer, "id", "sentinel");
			attr_dev(footer, "class", "svelte-rhnqca");
			add_location(footer, file$1, 115, 4, 3228);
			...
			add_location(div, file$1, 99, 0, 2709);
		},
		m: function mount(target, anchor) {
