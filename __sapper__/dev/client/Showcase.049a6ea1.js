...
import { A as ArtistListing } from './ArtistListing.d5902902.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-dyj184");
			add_location(div0, file, 74, 8, 1783);
			attr_dev(img, "class", "item-cover svelte-dyj184");
			...
			add_location(img, file, 75, 8, 1823);
			attr_dev(a0, "class", "item-cover-container svelte-dyj184");

			attr_dev(a0, "href", a0_href_value = "/albums/" + (/*type*/ ctx[2] == "tracks"
			? /*info*/ ctx[0].album.id
			: /*info*/ ctx[0].id));

			add_location(a0, file, 71, 4, 1666);
			attr_dev(a1, "class", "name text-no-overflow svelte-dyj184");

			attr_dev(a1, "href", a1_href_value = "/albums/" + (/*type*/ ctx[2] == "tracks"
			? /*info*/ ctx[0].album.id
			: /*info*/ ctx[0].id));

			add_location(a1, file, 80, 4, 1984);
			attr_dev(div1, "class", "item svelte-dyj184");
			attr_dev(div1, "id", /*key*/ ctx[3]);
			set_style(div1, "--width", /*width*/ ctx[4] + "px");
			set_style(div1, "--margin", /*marginLeft*/ ctx[1] + "px");
			add_location(div1, file, 66, 0, 1546);
		},
