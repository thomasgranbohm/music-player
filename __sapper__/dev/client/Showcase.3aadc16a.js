...
import { A as ArtistListing } from './ArtistListing.6b20523f.js';
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file$1, 117, 12, 3299);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1psz6ap");
			add_location(h1, file$1, 98, 0, 2675);
			attr_dev(footer, "id", "sentinel");
			attr_dev(footer, "class", "svelte-1psz6ap");
			add_location(footer, file$1, 115, 4, 3211);
			attr_dev(div, "class", "items svelte-1psz6ap");
			...
			add_location(div, file$1, 99, 0, 2692);
		},
		m: function mount(target, anchor) {
