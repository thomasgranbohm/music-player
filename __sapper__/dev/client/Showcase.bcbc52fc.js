...
import { A as ArtistListing } from './ArtistListing.9036e5bf.js';
...
// (105:8) {#each items as item, i (item.id)}
function create_each_block(key_1, ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(105:8) {#each items as item, i (item.id)}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 97, 0, 2655);
			attr_dev(footer, "id", "sentinel");
			attr_dev(footer, "class", "svelte-rhnqca");
			add_location(footer, file$1, 114, 4, 3191);
			...
			add_location(div, file$1, 98, 0, 2672);
		},
		m: function mount(target, anchor) {
