...
import { A as ArtistListing } from './ArtistListing.2b2e9078.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(b, "class", "svelte-1nw36o1");
			add_location(b, file, 79, 8, 1944);
