...
import { A as ArtistListing } from './ArtistListing.ab9af121.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-1etgzai");
			add_location(div0, file, 81, 8, 1967);
			attr_dev(img, "class", "item-cover svelte-1etgzai");
			...
			attr_dev(a0, "class", "item-cover-container svelte-1etgzai");
			...
			attr_dev(a1, "class", "name text-no-overflow svelte-1etgzai");
			...
			attr_dev(div1, "class", "item svelte-1etgzai");
