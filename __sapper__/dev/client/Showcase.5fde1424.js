...
import { A as ArtistListing } from './ArtistListing.ff30876f.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-1nw36o1");
			add_location(div0, file, 70, 8, 1625);
			attr_dev(img, "class", "item-cover svelte-1nw36o1");
			...
			attr_dev(a0, "class", "item-cover-container svelte-1nw36o1");
			...
			attr_dev(a1, "class", "name text-no-overflow svelte-1nw36o1");
			...
			attr_dev(div1, "class", "item svelte-1nw36o1");
