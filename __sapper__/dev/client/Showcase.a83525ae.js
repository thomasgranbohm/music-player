...
import { A as ArtistListing } from './ArtistListing.afcae00e.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(footer, "class", "svelte-10bi96y");
			add_location(footer, file$1, 108, 4, 3090);
