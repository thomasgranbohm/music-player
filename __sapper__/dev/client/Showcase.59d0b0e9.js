...
import { A as ArtistListing } from './ArtistListing.07d4f3f9.js';
...
// (104:8) {#each items as item, i (item.id)}
function create_each_block(key_1, ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(104:8) {#each items as item, i (item.id)}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 96, 0, 2662);
			attr_dev(footer, "id", "sentinel");
			attr_dev(footer, "class", "svelte-rhnqca");
			add_location(footer, file$1, 113, 4, 3198);
			...
			add_location(div, file$1, 97, 0, 2679);
		},
		m: function mount(target, anchor) {
