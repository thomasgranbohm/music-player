...
import { A as ArtistListing } from './ArtistListing.014368c9.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-nwyv56");
			add_location(div0, file, 70, 8, 1652);
			attr_dev(img, "class", "item-cover svelte-nwyv56");
			...
			attr_dev(a0, "class", "item-cover-container svelte-nwyv56");
			...
			attr_dev(a1, "class", "name text-no-overflow svelte-nwyv56");
			...
			attr_dev(div1, "class", "item svelte-nwyv56");
