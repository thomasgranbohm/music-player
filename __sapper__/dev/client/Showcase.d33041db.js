...
import { A as ArtistListing } from './ArtistListing.8261883d.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-1hrdzc0");
			add_location(div0, file, 71, 8, 1653);
			attr_dev(img, "class", "item-cover svelte-1hrdzc0");
			...
			attr_dev(a0, "class", "item-cover-container svelte-1hrdzc0");
			...
			attr_dev(a1, "class", "name text-no-overflow svelte-1hrdzc0");
			...
			attr_dev(div1, "class", "item svelte-1hrdzc0");
