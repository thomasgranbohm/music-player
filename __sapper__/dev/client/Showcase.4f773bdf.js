...
import { A as ArtistListing } from './ArtistListing.2e606774.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-yxd4us");
			add_location(div0, file, 82, 8, 1970);
			attr_dev(img, "class", "item-cover svelte-yxd4us");
			...
			add_location(img, file, 83, 8, 2010);
			attr_dev(a0, "class", "item-cover-container svelte-yxd4us");

			attr_dev(a0, "href", a0_href_value = "/albums/" + (/*type*/ ctx[2] == "tracks"
			? /*info*/ ctx[0].album.id
			: /*info*/ ctx[0].id));

			add_location(a0, file, 79, 4, 1853);
			attr_dev(a1, "class", "name text-no-overflow svelte-yxd4us");

			attr_dev(a1, "href", a1_href_value = "/albums/" + (/*type*/ ctx[2] == "tracks"
			? /*info*/ ctx[0].album.id
			: /*info*/ ctx[0].id));

			add_location(a1, file, 88, 4, 2171);
			attr_dev(div1, "class", "item svelte-yxd4us");
			attr_dev(div1, "id", /*key*/ ctx[3]);
			set_style(div1, "--width", /*width*/ ctx[4] + "px");
			set_style(div1, "--margin", /*marginLeft*/ ctx[1] + "px");
			add_location(div1, file, 74, 0, 1733);
		},
