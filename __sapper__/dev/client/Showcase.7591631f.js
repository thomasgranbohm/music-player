...
import { A as ArtistListing } from './ArtistListing.bb4afd3e.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-1en5fo2");
			add_location(div0, file, 73, 8, 1689);
			attr_dev(img, "class", "item-cover svelte-1en5fo2");
			...
			attr_dev(a0, "class", "item-cover-container svelte-1en5fo2");
			...
			attr_dev(a1, "class", "name text-no-overflow svelte-1en5fo2");
			...
			attr_dev(div1, "class", "item svelte-1en5fo2");
