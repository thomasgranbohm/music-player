...
import { A as ArtistListing } from './ArtistListing.503aff60.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "gray-background svelte-ini04a");
			add_location(div0, file, 74, 8, 1806);
			attr_dev(img, "class", "item-cover svelte-ini04a");
			...
			attr_dev(a0, "class", "item-cover-container svelte-ini04a");
			...
			attr_dev(a1, "class", "name text-no-overflow svelte-ini04a");
			...
			attr_dev(div1, "class", "item svelte-ini04a");
